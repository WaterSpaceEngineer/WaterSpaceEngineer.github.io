const touchSubMenuAll = () => {
  let isMobile = {
    ...
    const submenuProductsBtns = document.querySelectorAll('[data-submenu-products]');
    const submenuListItems = document.querySelectorAll('.submenu-list__item');
    const subSubmenuProductsBtns = document.querySelectorAll('[data-sub-submenu-products]');
    const subSubmenuListItems = document.querySelectorAll('.sub-submenu-list__item');
