...
const modals = () => {
    ...
    if(popups.length > 0) {
        bindModal('.condition__button.delivery', '.popup-delivery', '.popup-delivery .popup__wrap', '.popup-delivery .popup__inner', '.popup-delivery .popup__close');
        bindModal('.condition__button.payment', '.popup-payment', '.popup-payment .popup__wrap', '.popup-payment .popup__inner', '.popup-payment .popup__close');
    }
